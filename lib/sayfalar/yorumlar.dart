...
import 'package:social_app/modeller/yorum.dart';
...
class _YorumlarState extends State<Yorumlar> {
  ...
  @override
  /** timeago daki tarih bilgisini türkçe olarak ayarlamak */
  void initState() {
    super.initState();
    ...
    return FutureBuilder<Kullanici>(
        ...
        builder: (context, snapshot) {
          if (!snapshot.hasData) {
            ...
            /** yorumlar yüklenene kadar hata vermemesi için kullanıldı. */
          }
